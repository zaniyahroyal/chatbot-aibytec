...
if st.session_state['page'] == 'form':
    ...
    st.write("You can fill out the form to share your profile or start chatting directly with our AI chatbot.")
    ...
    # Option to skip the form
    with col2:
        st.markdown("### Skip the Form")
        if st.button("Chat with AI Chatbot"):
            st.session_state['page'] = 'chat'
            st.rerun()
