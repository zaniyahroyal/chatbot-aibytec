...
if st.session_state['page'] == 'form':
    ...
    with st.form(key="user_form"):
        ...
        submitted = st.form_submit_button("Hidden Submit")  # Invisible for internal functionality
        continue_chat = st.form_submit_button("Hidden Continue Chat")  # Invisible for internal functionality
